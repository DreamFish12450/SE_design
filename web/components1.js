      ...
      <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            ...
            <li>
              <a href="${window.ppath}/showparkingplace.jsp"><i class="icon-flask"></i>车位查询</a>
            </li>
            <li>
              <a href="${window.ppath}/showfee.jsp"><i class="icon-flask"></i>账单显示</a>
            </li>
            <li>
              <a href="${window.ppath}/SetEndtime.jsp"><i class="icon-flask"></i>手动结束停车时间</a>
            </li>
